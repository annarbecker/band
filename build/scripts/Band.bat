...
@rem ##########################################################################
@rem
@rem  Band startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and BAND_OPTS to pass JVM options to this script.
...
@rem Execute Band
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %BAND_OPTS%  -classpath "%CLASSPATH%" App %CMD_LINE_ARGS%
...
:fail
rem Set variable BAND_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%BAND_EXIT_CONSOLE%" exit 1
exit /b 1
